...
tar -xzf OpenSDL.tar.gz -C core
export LD_LIBRARY_PATH=$(pwd)/core/bin

sed -i 's/; WSServerCertificatePath/WSServerCertificatePath/g' core/bin/smartDeviceLink.ini
sed -i 's/; WSServerKeyPath/WSServerKeyPath/g' core/bin/smartDeviceLink.ini
sed -i 's/; WSServerCACertificatePath/WSServerCACertificatePath/g' core/bin/smartDeviceLink.ini
...
cp ${WORKSPACE}/files/Security/WebEngine/server-cert.pem ${WORKSPACE}/core/bin/
cp ${WORKSPACE}/files/Security/WebEngine/server-key.pem ${WORKSPACE}/core/bin/
cp ${WORKSPACE}/files/Security/WebEngine/ca-cert.pem ${WORKSPACE}/core/bin/
